...
$('#modalEditContent').on('hide.bs.modal', function (e) {
  if (e.namespace == 'bs.modal') {
    ...
    $(".form-edit-meta-description").removeClass("has-error");
    $(".edit-meta-description-error").css("display","none");    
  ...
  $.ajax({
    ...
    success:function(msg){
     ...
     // for( var twice = 0; twice < 2 ; twice++ ){
        ...
        $('#edit-meta-title').val(obj.data["0"].meta_title);
        $('#edit-meta-description').val(obj.data["0"].meta_description);
        // if (obj.vdo) {
...
function validate_edit_content(data) {
  ...
  if (description.val().length < 20 || description.val().length > 70) {
    description.focus();
  ...
  if($("#edit-meta-description").val().length < 70 || $("#edit-meta-description").val().length > 155){
    $("#edit-meta-description").focus();
    $(".form-edit-meta-description").addClass("has-error");
    $(".edit-meta-description-error").css("display","block");
    return false;
  } else {
    $(".form-edit-meta-description").removeClass("has-error");
    $(".edit-meta-description-error").css("display","none");
  ...
  var data = {
      ...
      meta_desc: $("#edit-meta-description").val(),
