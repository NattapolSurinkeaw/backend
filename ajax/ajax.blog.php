...
require_once dirname(__DIR__) . '/classes/class.blog.php';
...
if (isset($_REQUEST['action'])) {
    ...
    switch ($_REQUEST['action']) {
        ...
        case 'getcategorycontent':
            ...
            $category = $mydata->get_category(4);
        ...
        case 'addcontent':
            ...
            if(!getData::slug_exists($slug)){
                ...
                $table = "post";
                $field = "id,title,keyword,description,slug,topic,freetag,thumbnail,thumbnail2,h1,h2,video,category,tag,content,status_type,saleprice,specialprice,link_fb,link_tw,link_ig,display,date_created,date_edit,date_display,author,post_view,comment_allow,comment_count,pin,language,defaults,priority";
                $value = "	'" . $imax . "',
		        			'" . $_REQUEST['add-title'] . "',
            ...
            if ($check_slug) {//ค่า true คือ slug สามารถเอาไปใช้งานได้
                ...
                if ($_REQUEST['submit-type'] == 'edit') {
                    ...
                    $value = array(
                        ...
                        ":status_type" => $_REQUEST['edit-tech-status'],
                ...
                // เพิ่มเนื้อหาภาษาใหม่
                    ...
                    $table = "post";
                    $field = "id,title,keyword,description,slug,topic,freetag,thumbnail,h1,h2,video,category,tag,content,status_type,
