      ...
      <div class="modal-body">
        <div class="row body-row-content">
          ...
          <div class="col-content col-md-9 scrollbar" id="scrollbar-edit">
            <form id="form-edit-content" class="form-edit-content">
              ...
              <div class="col-md-12">
                ...
                <label><?php echo $LANG_LABEL['title'];?> (H1)</label>
                  <input type="text" class="form-control" id="edit-title" name="edit-title" placeholder="<?php echo $LANG_LABEL['title'];?>" required>
                  <span class="help-block edit-title-error">Should be from 20-70 characters.</span>
                </div>
              </div>
              ...
              <div class="col-md-12">
                ...
                <label><?php echo $LANG_LABEL['description'];?></label>
                  ...
                  <span class="help-block edit-description-error">Should be from 70-155 characters.</span>
                </div> 
              </div>
              ...
              <div class="col-md-12">
                ...
                <label>Meta Description</label>
                  <textarea class="form-input form-control" id="edit-meta-description" name="edit-meta-description" required></textarea>
                </div>  
              </div>
