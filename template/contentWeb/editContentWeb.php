    ...
    <div class="modal-content">  
      ...
      <div class="modal-body">
        <div class="row body-row-content">
          <div class="col-content col-md-3" style="display:none;">
...
<!-- 
              ...
              <div class="col-md-12">
                <div class="form-group form-edit-description">
                  <label>คำอธิบาย (H1)</label>
                  <input type="text" class="form-control" id="edit-description" name="edit-description" placeholder="Description">
                  <span class="help-block edit-description-error">Should be from 20-70 characters.</span>
                </div> 
							</div>
              ...
              <!-- <div class="col-md-12">
                <div class="form-group">
                  <label>ราคา</label>
                  <input type="text" class="form-control" id="add-keyword" name="add-keyword" placeholder="ราคาสินค้า">
                </div>
							</div>  -->
              ...
              <!-- <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="add-proprice" name="add-proprice" placeholder="ราคาโปรโมชั่น">
                </div>
              </div>  -->
              ...
              <div class="col-md-12">
                <div class="form-group form-edit-meta-title">
                  <label>Meta title</label>
                  <input type="text" class="form-control" id="edit-meta-title" name="edit-meta-title" placeholder="Meta title">
                  <span class="help-block edit-meta-title-error">Should be from 30-60 characters.</span>
                </div>  
              </div>
              <div class="col-md-12">
                <div class="form-group form-edit-meta-description">
                  <label>Meta Description</label>
                  <textarea class="form-input form-control" id="edit-meta-description" style="height:150px;" name="edit-meta-description"></textarea>
                  <span class="help-block edit-meta-description-error">Should be from 70-155 characters.</span>
                </div>  
              </div>
<!-- 
              <div class="col-md-12"> 
                  ...
                  <div class="box box-tag">
                    <div class="box-body">
                      ...
                      <div class="form-social"> 
                        ...
                        <input type="text" class="form-control" id="edit-link-line" name="edit-link-line" placeholder="Line EX:https://line.me/ti/p/~@name">
                      </div>
                    </div>
                  </div>  
                </div> 
      ...
      <div class="modal-footer "> 
        ...
        <button type="click" class="btn btn-success pull-right" id="save-edit">
