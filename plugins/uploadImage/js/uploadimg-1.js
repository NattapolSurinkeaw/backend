...
var fnUploadImg = {
                ...
                if (!!file.type.match(/image.*/)) {
                    if (formdata) {
                        ...
                        if (defaults['preview'] == true) {
                            ...
                            fnUploadImg.load_preview_img(file, img_index, preview);
                        }
                    }
                }
            }
    ...
    load_preview_img: function (file, img_index, preview) { // load preview image
        ...
        if (defaults['multiple'] == true) {
            ...
            $(preview).find('#preview_img_1').src = URL.createObjectURL(file);
        }
    }
}
